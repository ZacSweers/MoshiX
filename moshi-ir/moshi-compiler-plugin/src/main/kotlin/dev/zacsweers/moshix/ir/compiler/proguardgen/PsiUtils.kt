...
internal fun KtAnnotated.findAnnotation(
  ...
  val hasStarImport =
    importPaths.filter { it.isAllUnder }.any { fqName.asString().startsWith(it.fqName.asString()) }
  ...
  importPaths
    ...
    .also { matchingImportPaths ->
      when {
        ...
        matchingImportPaths.size > 1 ->
          return matchingImportPaths
            .first { importPath -> module.canResolveFqName(importPath.fqName, classReference) }
            .fqName
      }
    }
