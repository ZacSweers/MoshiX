...
internal class RealMoshiModuleDescriptor private constructor(delegate: ModuleDescriptor) :
  ...
  internal class Factory {
    private val cache = mutableMapOf<ModuleDescriptor, RealMoshiModuleDescriptor>()
...
private fun KtClassOrObject.toClassId(): ClassId {
  val className =
    parentsWithSelf.filterIsInstance<KtClassOrObject>().toList().reversed().joinToString(
      separator = "."
    ) {
