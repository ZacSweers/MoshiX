...
import dev.zacsweers.moshisealed.codegen.asKModifier
...
import dev.zacsweers.moshisealed.codegen.toAnnotationSpec
import dev.zacsweers.moshisealed.codegen.toClassName
...
import org.jetbrains.kotlin.ksp.isInternal
...
//        }
  ...
  return TargetType(
    ...
    typeVariables = typeVariables.filterIsInstance<TypeVariableName>().also { logger.logging("[KSP] Filtered typevars: $it") },
